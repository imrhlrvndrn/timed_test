...
export const Card: FunctionComponent<TCardProps> = ({ test }) => {
    return (
        <Link href={test?.link}>
            <div className='cursor-pointer group focus:ring-1 hover:ring-1 hover:ring-purple-600 focus:ring-purple-600 outline-none flex flex-col text-slate-200 p-6 border border-neutral-800 rounded-md md:max-w-full animate-transition'>
